...
<head>
	...
	<script type="text/javascript" src="<?php echo BASE; ?>asset/js/modernizr-2.8.1.min.js"></script>
</head>
<body class="ui-loading">
    ...
    <script type="text/javascript" src="<?php echo BASE; ?>asset/js/hammer-1.1.2.min.js"></script>
