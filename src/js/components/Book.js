    ...
    render() {
        ...
        return <div>
            <div className="BookInfo">
                ...
                {this.props.book.read || <div>You didn't read this book <button className="Button" onClick={this.props.onRead}>Mark as read</button></div>}
            </div>
            <ExtendedPhotoSwipeGallery items={items} options={options} thumbnailContent={this.renderThumbnail} afterChange={this.handleChange} onClose={this.handleClose} />
        </div> 
    }
